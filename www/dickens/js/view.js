...
function getArticle(rsid, loc, page, elem, words){
	if (elem != undefined && words != undefined){
		var url = '/dickens/?operation=search&mode=article&id=' + rsid + '&page=' + page + '&elem=' + elem + '&words=' + words;
	} 
	else {
		var url = '/dickens/?operation=search&mode=browse&id=' + rsid + '&page=' + page;
	}	
	loc.innerHTML="<img src='/dickens/js/images/indicator.white.gif'/>";
