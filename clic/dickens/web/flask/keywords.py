...
def processArgs(args):
    ...
    #testIdxName = "{0}-{1}".format(args["testIdxMod"], args["testIdxGroup"])
    #refIdxName = "{0}-{1}".format(args["refIdxMod"], args["refIdxGroup"])
