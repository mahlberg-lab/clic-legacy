...
class PhraseSearchOneTerm(unittest.TestCase):
    ...
    def test_basic_query(self):
        ...
        self.assertEqual(fog[1:], [
            ...
            [['Fog ', ' on ', ' the ', ' Essex ', ' marshes,', ' fog ', ' on ', ' the ', ' Kentish ', ' heights.'], ['Fog '], [' creeping ', ' into ', ' the ', ' cabooses ', ' of ', ' collier-brigs;', ' fog ', ' lying ', ' out ', ' on '], ['BH', u'Bleak House', '1', '2', '12', '216', '2615'], ['2', '12', '216', '354362']],
            ...
            [[' the ', ' Kentish ', ' heights.', 'Fog ', ' creeping ', ' into ', ' the ', ' cabooses ', ' of ', ' collier-brigs;'], [' fog '], [' lying ', ' out ', ' on ', ' the ', ' yards ', ' and ', ' hovering ', ' in ', ' the ', ' rigging '], ['BH', u'Bleak House', '1', '2', '12', '223', '2615'], ['2', '12', '223', '354362']],
            ...
            [[' in ', " Lincoln's ", ' Inn ', ' Hall,', ' at ', ' the ', ' very ', ' heart ', ' of ', ' the '], [' fog,'], [' sits ', ' the ', ' Lord ', ' High ', ' Chancellor ', ' in ', ' his ', ' High ', ' Court ', ' of '], ['BH', u'Bleak House', '1', '4', '18', '433', '2615'], ['4', '18', '433', '354362']],
            ...
            [[' moment ', ' to ', ' ask ', ' a ', ' question ', ' and ', ' left ', ' us ', ' in ', ' the '], [' fog,'], [' with ', ' the ', ' Lord ', " Chancellor's ", ' carriage ', ' and ', ' servants ', ' waiting ', ' for ', ' him '], ['BH', u'Bleak House', '3', '158', '366', '7479', '7896'], ['221', '582', '12995', '354362']],
            ...
            [[" ship's ", ' cabin,', ' and ', ' that ', ' delighted ', ' Charley ', ' very ', ' much.', 'Then ', ' the '], [' fog '], [' began ', ' to ', ' rise ', ' like ', ' a ', ' curtain,', ' and ', ' numbers ', ' of ', ' ships '], ['BH', u'Bleak House', '45', '29', '84', '1847', '5378'], ['4969', '13532', '248309', '354362']],
            ...
            [[' anything ', ' but ', ' regal ', ' in ', ' a ', ' drizzling ', ' rain ', ' and ', ' a ', ' dark-brown '], [' fog,'], [' until ', ' I ', ' was ', ' admonished ', ' by ', ' the ', ' waiter ', ' that ', ' the ', ' gentleman '], ['DC', u'David Copperfield', '20', '1', '3', '149', '3636'], ['2284', '5784', '118140', '356233']],
            ...
            [['A ', ' man,', ' sitting ', ' in ', ' a ', ' pigeon-hole-place,', ' looked ', ' out ', ' of ', ' the '], [' fog,'], [' and ', ' took ', ' money ', ' from ', ' somebody,', ' inquiring ', ' if ', ' I ', ' was ', ' one '], ['DC', u'David Copperfield', '24', '37', '143', '2639', '3516'], ['2874', '7416', '147652', '356233']],
            ...
            [[' they ', ' had ', ' been ', ' small ', ' suns ', ' looking ', ' at ', ' you ', ' through ', ' a '], [' fog;'], [' and ', ' a ', ' newly-awakened ', ' manner,', ' such ', ' as ', ' he ', ' might ', ' have ', ' acquired '], ['DS', u'Dombey and Son', '4', '6', '18', '794', '4877'], ['361', '775', '15098', '356405']],
            ...
            [[' with ', ' Alexander,', ' still ', ' upon ', ' the ', ' paving-stone,', ' dimly ', ' looming ', ' through ', ' a '], [' fog '], [' of ', ' dust;', ' and ', ' so ', ' absorbed ', ' was ', ' Mrs ', ' MacStinger ', ' in ', ' her '], ['DS', u'Dombey and Son', '23', '102', '232', '6272', '9281'], ['2856', '6412', '137199', '356405']],
            [[' December ', ' afternoon ', ' towards ', ' six ', " o'clock,", ' when ', ' it ', ' was ', ' filled ', ' with '], [' fog,'], [' and ', ' candles ', ' shed ', ' murky ', ' and ', ' blurred ', ' rays ', ' through ', ' the ', ' windows '], ['ED', u'The Mystery of Edwin Drood', '11', '3', '7', '276', '5263'], ['978', '2219', '37294', '94126']],
            ...
            [[' you ', ' do,', ' Mr.', ' Edwin?', 'Dear ', ' me,', " you're ", " choking!'", "'It's ", ' this '], [" fog,'"], [' returned ', ' Edwin;', "'and ", ' it ', ' makes ', ' my ', ' eyes ', ' smart,', ' like ', ' Cayenne '], ['ED', u'The Mystery of Edwin Drood', '11', '19', '47', '1095', '5263'], ['994', '2259', '38113', '94126']],
            [[" chair.'", 'Edwin ', ' took ', ' the ', ' easy-chair ', ' in ', ' the ', ' corner;', ' and ', ' the '], [' fog '], [' he ', ' had ', ' brought ', ' in ', ' with ', ' him,', ' and ', ' the ', ' fog ', ' he '], ['ED', u'The Mystery of Edwin Drood', '11', '23', '56', '1188', '5263'], ['998', '2268', '38206', '94126']],
            ...
            [[' been ', ' the ', ' proximate ', ' cause ', ' of ', ' this ', ' sumptuous ', ' repast,', ' so ', ' the '], [' fog '], [' served ', ' for ', ' its ', ' general ', ' sauce.', 'To ', ' hear ', ' the ', ' out-door ', ' clerks '], ['ED', u'The Mystery of Edwin Drood', '11', '62', '131', '2356', '5263'], ['1037', '2343', '39374', '94126']],
            ...
            [[' too!', 'And ', ' a ', ' mist ', ' upon ', ' the ', ' Hollow!', 'Not ', ' a ', ' dull '], [' fog '], [' that ', ' hides ', ' it,', ' but ', ' a ', ' light ', ' airy ', ' gauze-like ', ' mist,', ' which '], ['MC', u'Martin Chuzzlewit', '36', '40', '135', '2908', '8861'], ['4716', '11863', '225332', '335750']],
            ...
            [[' the ', ' light ', ' of ', ' its ', ' kiln-fires ', ' made ', ' lurid ', ' smears ', ' on ', ' the '], [' fog,'], [' R.', ' Wilfer ', ' sighed ', ' and ', ' shook ', ' his ', ' head.', "'Ah ", " me!'", ' said '], ['OMF', u'Our Mutual Friend', '4', '8', '22', '686', '4703'], ['313', '687', '12740', '326116']],
            [[' kitchen-garden,', ' brick ', ' viaduct,', ' arch-spanned ', ' canal,', ' and ', ' disorder ', ' of ', ' frowziness ', ' and '], [' fog.'], ['As ', ' if ', ' the ', ' child ', ' had ', ' given ', ' the ', ' table ', ' a ', ' kick,'], ['OMF', u'Our Mutual Friend', '18', '31', '86', '1940', '7418'], ['2139', '4903', '85532', '326116']],
            ...
            [[' on ', ' the ', ' fender.', "It's ", ' a ', ' cold,', ' cold ', ' night,', ' and ', ' the '], [' fog '], [' clings ', " so.'", 'As ', ' Miss ', ' Abbey ', ' helped ', ' her ', ' to ', ' turn ', ' her '], ['OMF', u'Our Mutual Friend', '35', '64', '155', '2347', '4014'], ['4461', '10331', '173574', '326116']],
            [[" it?'", ' asked ', ' Miss ', ' Abbey.', "'It's ", ' summut ', ' run ', ' down ', ' in ', ' the '], [' fog,'], [" ma'am,'", ' answered ', ' Bob.', "'There's ", ' ever ', ' so ', ' many ', ' people ', ' in ', ' the '], ['OMF', u'Our Mutual Friend', '35', '74', '187', '3046', '4014'], ['4471', '10363', '174273', '326116']],
            [[' a ', ' steamer,', ' Miss ', " Abbey,'", ' cried ', ' one ', ' blurred ', ' figure ', ' in ', ' the '], [' fog.'], ["'It ", ' always ', ' IS ', ' a ', ' steamer,', ' Miss ', " Abbey,'", ' cried ', ' another.', "'Them's "], ['OMF', u'Our Mutual Friend', '35', '79', '199', '3218', '4014'], ['4476', '10375', '174445', '326116']],
            [[' off ', ' her ', ' steam,', ' Miss ', ' Abbey,', ' and ', " that's ", ' what ', ' makes ', ' the '], [' fog '], [' and ', ' the ', ' noise ', ' worse,', " don't ", ' you ', " see?'", ' explained ', ' another.', 'Boats '], ['OMF', u'Our Mutual Friend', '35', '82', '202', '3252', '4014'], ['4479', '10378', '174479', '326116']],
            [[' river,', ' for ', ' every ', ' boat ', ' that ', ' put ', ' off ', ' sculled ', ' into ', ' the '], [' fog '], [' and ', ' was ', ' lost ', ' to ', ' view ', ' at ', ' a ', " boat's ", ' length.', 'Nothing '], ['OMF', u'Our Mutual Friend', '35', '83', '207', '3332', '4014'], ['4480', '10383', '174559', '326116']],
            ...
            [[' by ', ' keeping ', ' close ', ' ward ', ' over ', ' a ', ' long ', " day's ", ' work ', ' in '],[' fog '], [' and ', ' rain,', ' Silas ', ' would ', ' have ', ' just ', ' crawled ', ' to ', ' bed ', ' and '], ['OMF', u'Our Mutual Friend', '64', '3', '11', '265', '4951'], ['8001', '18585', '309175', '326116']],
            [[' the ', ' reeking ', ' bodies ', ' of ', ' the ', ' cattle,', ' and ', ' mingling ', ' with ', ' the '], [' fog,'], [' which ', ' seemed ', ' to ', ' rest ', ' upon ', ' the ', ' chimney-tops,', ' hung ', ' heavily ', ' above.'], ['OT', u'Oliver Twist', '21', '4', '14', '415', '2162'], ['1421', '3034', '57493', '157020']],
